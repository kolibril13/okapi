...
class GEO_OT_RenameAndDelete(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        self.report({'INFO'}, f"Renamed '{old_name}' → 'shapekey_object', deleted {len(other_copies)} copies.")
        return {'FINISHED'}
...
def register():
    ...
    bpy.types.Scene.geonodes_to_shapekey_props = bpy.props.PointerProperty(type=GEO_Props)
